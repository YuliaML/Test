...
author: 
  - Yulia Flury, yulia.flury@stud.hslu.ch
  - Anastasiia Popova, anastasiia.popova@stud.hslu.ch
...
# data
df <- read.csv("../data/journals.csv", header = TRUE) %>% 
...
-------  ---- ------ -----------------
Bennett 2015 Experimental Journal of Bone
...
```{r, screenshot, echo=FALSE, fig.cap="A screenshot of the Google Scholar homepage\\label{figurefirst"}
...
lm2 <- lm (h5_index ~ english, data = df)
lm3 <- lm (h5_index ~ subfield, data = df)
stargazer(data = list(lm1, lm2), type = "text", 
